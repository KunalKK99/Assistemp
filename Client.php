...
$display = "
<div class=\"up\">
<div class=\"ff\">PF1 : <a href='file.php?year=".$_GET["year"]."&month=".$_GET["month"]."&sample=PF-ECR' target=\"_blank\">Download</a></div>
<br>
<div class=\"ff\">PF2 : <a href='file.php?year=".$_GET["year"]."&month=".$_GET["month"]."&sample=PF challan' target=\"_blank\">Download</a></div>
<br>
<div class=\"ff\">ESI : <a href='file.php?year=".$_GET["year"]."&month=".$_GET["month"]."&sample=ESI challan' target=\"_blank\">Download</a></div></div>
";
